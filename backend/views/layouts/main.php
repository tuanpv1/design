    ...
    $menuItems = [
        ...
        [
            ...
            'items' => [
                ...
                [
                    'encode' => false,
                    'label' => News::getTypeName(News::TYPE_PROJECT),
                    'url' => ['news/index', 'type' => News::TYPE_PROJECT],
                ],
                [
                    'encode' => false,
                ...
                [
                    'encode' => false,
                    'label' => 'Tiện ích',
                    'url' => ['news/index', 'type' => News::TYPE_TI],
                ],
            ]
        ],
        [
            'encode' => false,
            'label' => Yii::t('app','Danh mục menu top'),
            'url' => ['category/index'],
        ],
        [
            'label' => Yii::t('app','QL bài viết menu'),
            'url' => 'javascript:;',
            'options' => ['class' => 'menu-dropdown mega-menu-dropdown'],
            'linkOptions' => ['data-hover' => 'megamenu-dropdown', 'data-close-others' => 'true'],
            'items' => [
