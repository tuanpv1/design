...
<script lang="javascript">(function() {var pname = ( (document.title !='')? document.title : document.querySelector('h1').innerHTML );var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async=1; ga.src = '//live.vnpgroup.net/js/web_client_box.php?hash=a23aceeb8b47444d057ea46000e16dda&data=eyJzc29faWQiOjQ5NTI0NTEsImhhc2giOiJjZTZlY2MwNzY4NzMzYzRkYTFlYzMyY2UxY2Y2M2RlMSJ9&pname='+pname;var s = document.getElementsByTagName('script');s[0].parentNode.insertBefore(ga, s[0]);})();</script>
<?php $this->endBody() ?>
</html>
<?php $this->endPage() ?>
